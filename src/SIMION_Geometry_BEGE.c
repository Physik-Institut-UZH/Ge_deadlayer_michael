...
double GetBegeVoltage(){return SIMION_Voltage_Bege;}
double GetBegeEpsScale(){return SIMION_EpsScale_Bege;}
double GetBegeEpsExtScale(){return SIMION_EpsExtScale_Bege;}
